...
function(a, b, c, d) {
    ...
    e.Defaults = {
        ...
        return this.settings.freeDrag || a.each(g, a.proxy(function(a, h) {
            return "left" === c && b > h - 30 && b < h + 30 ? d = a : "right" === c && b > h - f - 30 && b < h - f + 30 ? d = a + 1 : this.op(b, "<", h) && this.op(b, ">", g[a + 1] || h - f) && (d = "left" === c ? a + 1 : a), 
            -1 === d;
    ...
    $(".menu li.active").addClass("open").children("ul").show(), $(".menu li.has-sub>a").on("click", function() {
        $(this).removeAttr("href");
        var element = $(this).parent("li");
        element.hasClass("open") ? (element.removeClass("open"), element.find("li").removeClass("open"), 
        element.find("ul").slideUp(200)) : (element.addClass("open"), element.children("ul").slideDown(200), 
        element.siblings("li").children("ul").slideUp(200), element.siblings("li").removeClass("open"), 
        element.siblings("li").find("li").removeClass("open"), element.siblings("li").find("ul").slideUp(200));
    });
});

var menuTrigger = document.getElementById("menu-trigger"), leftMenu = document.getElementById("left-menu"), sideMenu = document.getElementById("side-menu"), dashboardArea = document.getElementById("dashboard-area");

menuTrigger.onclick = function() {
    // $('#side-menu').addClass('col-xs-1').removeClass('col-xs-2');
    // $('#dashboard-area').addClass('col-xs-11').removeClass('col-xs-10');
    $("#side-menu").toggleClass("col-xs-1 col-xs-2"), $("#dashboard-area").toggleClass("col-xs-11 col-xs-10"), 
    ...
    menuTrigger.classList.toggle("active"), $(menuTrigger).hasClass("active") && $(sideMenu).hasClass("col-xs-2") ? ($("#side-menu>#menu-trigger").css({
        background: "#242424",
        border: "1px solid #242424"
    }), $("#left-menu .menu>ul>li>a").css({
        visibility: "visible"
    }), $(".col-xs-2").css("max-width", "16.66667%"), $(".col-xs-10").css("max-width", "83.33333%")) : ($("#side-menu>#menu-trigger").css({
        background: "#646464",
        border: "1px solid #646464"
    }), $("#left-menu .menu>ul>li>a").css({
        visibility: "hidden"
    }), $(".col-xs-1").css("max-width", "3%"), $(".col-xs-11").css("max-width", "97%"));
};
