...
<head>
	...
	<meta charset="utf-8">
	<title><?php echo empty($obj-> page_meta) ? "Admin Dashboard" : $obj-> page_meta["title"] . " | " . $site_title ?></title>
	...
	<script src="/<?php print('themes/admin/core/assets/js/head.js'); ?>" async></script>
	<link rel="stylesheet" href="/<?php print('themes/admin/core/assets/dropzone.css'); ?>">
	<link rel="stylesheet" href="/<?php print('themes/admin/core/assets/style.css'); ?>">
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css">
	<!--[if lte IE 8]><script src="/<?php print('themes/admin/assets/js/respond.js'); ?>"></script><![endif]-->
</head>
